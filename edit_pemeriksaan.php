...
do {  
?>
          <option value="<?php echo $row_pasien['no_pas']?>" <?php if (!(strcmp($row_pasien['no_pas'], htmlentities($row_pemeriksaan['no_pas'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_pasien['nama_pas']?></option>
          <?php
...
?>
    ...
    <tr valign="baseline">
      ...
      <td><div align="left">
        <textarea name="tindakan" cols="50" rows="5"><?php echo htmlentities($row_pemeriksaan['tindakan'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </div></td>
    </tr>
    <tr valign="baseline">
